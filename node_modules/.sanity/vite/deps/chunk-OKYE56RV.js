...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources3-UCSRW7FU.js")
});
...
var useRoleRequestsStatus = () => {
  const client = useClient({ apiVersion: "2024-07-01" }), projectId = useProjectId(), checkRoleRequests = (0, import_react.useMemo)(() => !client || !projectId ? of({ loading: false, error: false, status: "none" }) : from(
    client.request({
    ...
    startWith({ loading: true, error: false, status: void 0 })
    ...
    tools: [
      {
        ...
        icon,
        component: (0, import_react.lazy)(() => import("./index3-ZKQAUT3W.js")),
...
@tanstack/react-table/build/lib/index.mjs:
  (**
     ...
     *)
*/
//# sourceMappingURL=chunk-OKYE56RV.js.map
