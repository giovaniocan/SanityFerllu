...
const useRoleRequestsStatus = () => {
  const client = sanity.useClient({ apiVersion: "2024-07-01" }), projectId = sanity.useProjectId(), checkRoleRequests = React.useMemo(() => !client || !projectId ? rxjs.of({ loading: !1, error: !1, status: "none" }) : rxjs.from(
    client.request({
    ...
    operators.map((requests) => {
      if (requests && requests.length) {
        ...
        if (declinedRequest && dateFns.isAfter(dateFns.addWeeks(new Date(declinedRequest.createdAt), 2), /* @__PURE__ */ new Date()))
    ...
    operators.startWith({ loading: !0, error: !1, status: void 0 })
    // Start with loading state
  ), [client, projectId]), { loading, error, status } = reactRx.useObservable(checkRoleRequests, {
    loading: !0,
    error: !1,
    status: void 0
  });
...
const preventDefault = (ev) => ev.preventDefault(), FormView = React.forwardRef(function(props, ref) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ui.Container,
    {
      ...
      sizing: "border",
      width: 1,
      children: /* @__PURE__ */ jsxRuntime.jsx(sanity.PresenceOverlay, { margins, children: /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { as: "form", onSubmit: preventDefault, ref: setRef, children: connectionState === "connecting" || !ready ? /* @__PURE__ */ jsxRuntime.jsx(Delay, { ms: 300, children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", direction: "column", height: "fill", justify: "center", children: [
